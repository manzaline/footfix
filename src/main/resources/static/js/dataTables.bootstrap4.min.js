!function (t) {
  "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function (e) {
    ...
    return e = e || window, a && a.fn.dataTable || (a = require("datatables.net")(e, a).$), t(a, 0, e.document)
  } : t(jQuery, window, document)
}(function (h, e, n, o) {
  var s = h.fn.dataTable;
  return h.extend(!0, s.defaults, {
  ...
  }), s.ext.renderer.pageButton.bootstrap = function (d, e, i, a, l, c) {
    var u, p, t, f = new s.Api(d), m = d.oClasses, b = d.oLanguage.oPaginate, g = d.oLanguage.oAria.paginate || {},
      x = 0, w = function (e, a) {
        function t(e) {
          e.preventDefault(), h(e.currentTarget).hasClass("disabled") || f.page() == e.data.action || f.page(e.data.action).draw("page")
        }

        for (var n, o, s = 0, r = a.length; s < r; s++) if (o = a[s], h.isArray(o)) w(e, o); else {
          switch (p = u = "", o) {
            case"ellipsis":
              u = "&#x2026;", p = "disabled";
              break;
          ...
          u && (n = h("<li>", {
            ...
            class: "page-link"
          }).html(u)).appendTo(e), d.oApi._fnBindAction(n, {action: o}, t), x++)
        }
      };
    try {
    ...
    w(h(e).empty().html('<ul class="pagination"/>').children("ul"), a), t !== o && h(e).find("[data-dt-idx=" + t + "]").trigger("focus")
  }, s
});